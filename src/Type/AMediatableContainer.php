<?php
/**
 * AMediatableContainer.php | Feb 05, 2014
 *
 * @filesource
 * @license MIT
 ...
 * <pre>
 * +--------------------------+       +----------------+       +------------------+
 * | MEDIATABLEOCONTAINER     |<------| OBJECTSTORAGE  |<--+---| ArrayObject      |
 * +--------------------------+       +----------------+   |   +------------------+
 ...
 */
abstract class AMediatableContainer extends \BLW\Type\AContainer implements \BLW\Type\IMediatable
{
