<?php
/**
 * MediatableObjectTest.php | Feb 14, 2014
 *
 * @filesource
 * @license MIT
 ...
 *
 *  @coversDefaultClass \BLW\Type\AMediatableObjectStorage
 */
class MediatableObjectStorageTest extends \BLW\Type\MediatableTest
{
    protected function setUp()
    {
        ...
        $this->Mediatable = $this->getMockForAbstractClass('\\BLW\\Type\\AMediatableObjectStorage');
