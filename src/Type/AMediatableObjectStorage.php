<?php
/**
 * AMediatableObjectStorage.php | Feb 05, 2014
 *
 * @filesource
 * @license MIT
 ...
 * <pre>
 * +---------------------------------------------------+       +----------------+       +------------------+
 * | MEDIATABLEOBJECTSTORAGE                           |<------| OBJECTSTORAGE  |<--+---| SplObjectStorage |
 * +---------------------------------------------------+       +----------------+   |   +------------------+
 ...
 */
abstract class AMediatableObjectStorage extends \BLW\Type\AObjectStorage implements \BLW\Type\IMediatable
{
