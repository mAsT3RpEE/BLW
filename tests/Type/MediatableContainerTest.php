<?php
/**
 * MediatableContainerTest.php | Feb 14, 2014
 *
 * @filesource
 * @license MIT
 ...
 *
 *  @coversDefaultClass \BLW\Type\AMediatableContainer
 */
class MediatableContainerTest extends MediatableTest
{
    protected function setUp()
    {
        ...
        $this->Mediatable = $this->getMockForAbstractClass('\\BLW\\Type\\AMediatableContainer');
