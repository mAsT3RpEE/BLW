 ...
 * @property integer $_MaxConnections [protected] Maximum connections to a server to make at once.
 * @property integer $_MaxRequests [protected] Maximum number of <code>IRequest</code> to run at once.
 * @property integer $_MaxRate [protected] Maximum rate of <code>IRequest</code> to execute per minute.
 */
interface IClient extends \BLW\Type\IObjectStorage, \BLW\Type\IMediatable, \BLW\Type\IFactory
{
     ...
     * @return boolean <code>TRUE</code> if successful. <code>FALSE</code> if unsuccessful or if all requests were already qued.
     */
