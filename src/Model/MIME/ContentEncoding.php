<?php
/**
 * ContentEncoding.php | Apr 8, 2014
 *
 * @filesource
 * @license MIT
...
/**
 * Header class for Content-Encoding.
 *
 * <h3>RFC2616</h3>
 *
 * <pre>
 * Content-Encoding := "Content-Encoding" ":" 1*(encoding)
 * encoding         := token
 *
 ...
 */
final class ContentEncoding extends \BLW\Type\MIME\AHeader
{
    ...
    public function __construct($Encodings)
    {
        ...
        if (! is_string($Encodings) && ! is_callable(array(
            ...
            // Type
            $this->_Value = array_reduce($Encodings, array($this, '_combine'), '');
