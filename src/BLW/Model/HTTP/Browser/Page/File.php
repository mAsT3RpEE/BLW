 ...
 */
class File extends \BLW\Type\HTTP\Browser\APage
{

    /**
     * Constructor
     *
     * @param \BLW\Type\IFile $Component
     *            File with loaded with Response body.
     ...
     */
    public function __construct(IFile $Component, IURI $Base, IHead $RequestHead, IHead $ResponseHead, IMediator $Mediator = null, $flags = IWrapper::WRAPPER_FLAGS)
    {
        // Properties
