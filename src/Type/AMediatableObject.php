<?php
/**
 * AMediatableObject.php | Feb 05, 2014
 *
 * @filesource
 * @license MIT
 ...
 * <pre>
 * +---------------------------------------------------+       +-------------------+       +--------------+
 * | MEDIATABLEOBJECT                                  |<------| OBJECT            |<--+---| SERIALIZABLE |
 * +---------------------------------------------------+       +-------------------+   |   | ============ |
 ...
 */
abstract class AMediatableObject extends \BLW\Type\AObject implements \BLW\Type\IMediatable
{
