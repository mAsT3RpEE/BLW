...
/**
 * Tests BLW DOM exception
 * @package BLW\Core
 * @author  mAsT3RpEE <wotsyula@mast3rpee.tk>
 *
 * @coversDefaultClass \BLW\Model\DOM\Exception
 */
class ExceptionTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $Expected = sprintf('!^.+%s::%s\x28\x29: DOM Error: Mock Error. Caused by [\s\S]+$!', preg_quote(__CLASS__), 'setUp');
