 ...
 *
 *  @coversDefaultClass \BLW\Type\AMediatableObject
 */
class MediatableObjectTest extends MediatableTest
{
    protected function setUp()
    {
        ...
        $this->Mediatable = $this->getMockForAbstractClass('\\BLW\\Type\\AMediatableObject');
