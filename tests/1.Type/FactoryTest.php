...
require_once __DIR__ . '/../Config/Factory.php';

/**
 * Tests BLW Library Factory type.
 * @package BLW\Core
 * @author mAsT3RpEE <wotsyula@mast3rpee.tk>
 */
class FactoryTest extends \PHPUnit_ObjectTest
{
    const TEST_CLASS    = '\\Factory';
	...
	{
        $TEST_CLASS = self::TEST_CLASS;
	    $Test1 = $TEST_CLASS::O('Object', array('foo' => 1), true);
	    $Test2 = $TEST_CLASS::O('Object', array('foo' => 1), false);

	    $this->assertInstanceOf('\\BLW\\Object', $Test1);
	    $this->assertInstanceOf('\\BLW\\Object', $Test1);
	    $this->assertEquals(1, @$Test1->Options->foo);
	    $this->assertEquals(1, @$Test2->Options->foo);
	}
